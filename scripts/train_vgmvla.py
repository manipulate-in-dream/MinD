...
sys.path.insert(1,'/mnt/world_foundational_model/xiaowei/VGA/VgmACT')
...
class TrainConfig:
    ...
    dataset_statistics_json: Optional[str] = None  
    use_full_ckpt_vgm: Optional[bool] = None  
    ...
    if cfg.pretrained_checkpoint is not None:
        ...
        if if_load_vgmvla:
            vla = load_vgmvla(cfg.pretrained_checkpoint, 
                            ...
                            dataset_statistics_json=cfg.dataset_statistics_json,
                            use_full_ckpt_vgm=cfg.use_full_ckpt_vgm
                            )
            print("if_load_vgmvla",if_load_vgmvla)
        else:
